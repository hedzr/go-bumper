...
const (
	// appName   = "bumper"
	copyright    = "bumper - A homebrew formula bumper - cmdr series"
	desc         = "bumper is a faked homebrew formula bumper"
	longDesc     = "bumper is a faked homebrew formula bumper. It makes an demo application for `cmdr`"
	examples     = ``
	examplesLong = `
...
# Star me if it's helpful: https://github.com/hedzr/go-bumper
		`),
